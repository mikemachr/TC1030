...
int main(){
    Estudiante E1("Juan Sanchez","A01234567","Ing. Mecatronica");
    Estudiante E2("Monica Perez","A01223344","Ing. en Tecnologias Computacionales");
    Estudiante E3("Carlos Augusto Amador","A01234455","Ing. Industrial");
    Profesor P1("Ernesto Ramirez","L00700700","Departamento de Computacion");
